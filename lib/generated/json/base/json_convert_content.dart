...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    ...
    if (<RankInforEntity>[] is M) {
      return data.map<RankInforEntity>((Map<String, dynamic> e) =>
          RankInforEntity.fromJson(e)).toList() as M;
    }
    if (<RankInforRankInfo>[] is M) {
      return data.map<RankInforRankInfo>((Map<String, dynamic> e) =>
          RankInforRankInfo.fromJson(e)).toList() as M;
    }
    if (<RankInforWebLinks>[] is M) {
      return data.map<RankInforWebLinks>((Map<String, dynamic> e) =>
          RankInforWebLinks.fromJson(e)).toList() as M;
    }
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    ...
    (RankInforEntity).toString(): RankInforEntity.fromJson,
    (RankInforRankInfo).toString(): RankInforRankInfo.fromJson,
    (RankInforWebLinks).toString(): RankInforWebLinks.fromJson,
  };
