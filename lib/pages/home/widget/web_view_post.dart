...
class WebViewPost extends StatefulWidget {
  String linkUrl;
  Post itemPost;
  WebViewController _webViewController = WebViewController();
  WebViewPost({super.key ,required this.linkUrl, required this.itemPost});
...
class _WebViewPost extends State<WebViewPost> {
  ...
  Widget titleWidget() {
    ...
    return Container(
      ...
      child: Text(widget.itemPost.title, style: textStyle,),
    );
  }
