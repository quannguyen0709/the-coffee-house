...
class BottomApppSheetOrder {
  final priceChose = 0.obs;
  bool firstBuild = true;
  int numberItemSelect = 1;
  void bottomSheetItemOrder(
      BuildContext context, Product? productData, int basePrice) {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Obx(() => selectOption(productData, priceChose.value))
                      ],
                    ),
                  )
                ],
  ...
  Widget selectOption(Product product, int priceChose) {
    ...
    final styleText =
    TextStyleApp.fontNotoSansLarge.copyWith(color: ColorApp.backgourdWhite);
              ...
              children: [
                ...
                Expanded(
                  child: Container(
                      ...
                      child: Center(
                        child: Text(
                          'Chọn . ${priceChose * numberItemSelect} đ',
                          style: styleText,
                        ),
                      )),
                )
  ...
  Widget informationProductWidget(Product inforData, BuildContext context) {
    ...
    final IconData favoriteSelect = Icons.favorite;
    final priceBase = inforData.basePrice;
    bool checkSelectFavortie = false;
              ...
              StatefulBuilder(
                builder: (context, setState) {
                  return GestureDetector(
                    onTap: () {
                      setState((){
                        checkSelectFavortie = !checkSelectFavortie;
                      });
                    },
                    child: Container(
                        ...
                        height: 12.0.wp,
                        width: 12.0.wp,
                        child: checkSelectFavortie ? Icon(favoriteSelect, color: ColorApp.primaryColor, ): Icon(favorite)),
                  );
                },
              )
            ],
