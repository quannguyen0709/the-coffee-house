...
import 'package:the_coffee_house_leanning/pages/login/binding.dart';
import 'package:the_coffee_house_leanning/pages/login/page.dart';
...
class AppPages{
  static List<GetPage> list = [
    GetPage(name: AppRoutes.LOGIN_PAGE, page: ()=> LoginPage(), binding: LoginBinding()),
